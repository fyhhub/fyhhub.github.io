import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.3da76edf.js";const q=JSON.parse('{"title":"husky、eslint、lint-staged 配置","description":"","frontmatter":{},"headers":[],"relativePath":"informal/开发技巧/husky、eslint、lint-staged配置.md","filePath":"informal/开发技巧/husky、eslint、lint-staged配置.md","lastUpdated":1694057540000}'),p={name:"informal/开发技巧/husky、eslint、lint-staged配置.md"},o=l(`<h1 id="husky、eslint、lint-staged-配置" tabindex="-1">husky、eslint、lint-staged 配置 <a class="header-anchor" href="#husky、eslint、lint-staged-配置" aria-label="Permalink to &quot;husky、eslint、lint-staged 配置&quot;">​</a></h1><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// package.json</span></span>
