import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.353e5930.js";const A=JSON.parse('{"title":"141.环形链表","description":"","frontmatter":{},"headers":[],"relativePath":"algorithm/链表/141.环形链表.md","filePath":"algorithm/链表/141.环形链表.md"}'),p={name:"algorithm/链表/141.环形链表.md"},o=l(`<h1 id="_141-环形链表" tabindex="-1"><a href="https://leetcode-cn.com/problems/linked-list-cycle/" target="_blank" rel="noreferrer">141.环形链表</a> <a class="header-anchor" href="#_141-环形链表" aria-label="Permalink to &quot;[141.环形链表](https://leetcode-cn.com/problems/linked-list-cycle/)&quot;">​</a></h1><h2 id="思路" tabindex="-1">思路 <a class="header-anchor" href="#思路" aria-label="Permalink to &quot;思路&quot;">​</a></h2><p>快慢指针，快指针每次走两步，慢指针每次走一步，如果有环就一定会相交</p><h2 id="题解" tabindex="-1">题解 <a class="header-anchor" href="#题解" aria-label="Permalink to &quot;题解&quot;">​</a></h2><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">/**</span></span>
