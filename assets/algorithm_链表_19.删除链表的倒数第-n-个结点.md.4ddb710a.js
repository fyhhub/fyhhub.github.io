import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.3d945e71.js";const D=JSON.parse('{"title":"19.删除链表的倒数第-n-个结点","description":"","frontmatter":{},"headers":[],"relativePath":"algorithm/链表/19.删除链表的倒数第-n-个结点.md","filePath":"algorithm/链表/19.删除链表的倒数第-n-个结点.md","lastUpdated":1699781856000}'),p={name:"algorithm/链表/19.删除链表的倒数第-n-个结点.md"},o=l(`<h1 id="_19-删除链表的倒数第-n-个结点" tabindex="-1"><a href="https://leetcode-cn.com/problems/remove-nth-node-from-end-of-list/submissions/" target="_blank" rel="noreferrer">19.删除链表的倒数第-n-个结点</a> <a class="header-anchor" href="#_19-删除链表的倒数第-n-个结点" aria-label="Permalink to &quot;[19.删除链表的倒数第-n-个结点](https://leetcode-cn.com/problems/remove-nth-node-from-end-of-list/submissions/)&quot;">​</a></h1><h2 id="题解" tabindex="-1">题解 <a class="header-anchor" href="#题解" aria-label="Permalink to &quot;题解&quot;">​</a></h2><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">/**</span></span>
