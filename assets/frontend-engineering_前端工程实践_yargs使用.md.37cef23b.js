import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.3d945e71.js";const g=JSON.parse('{"title":"yargs 使用","description":"","frontmatter":{},"headers":[],"relativePath":"frontend-engineering/前端工程实践/yargs使用.md","filePath":"frontend-engineering/前端工程实践/yargs使用.md","lastUpdated":1697009812000}'),p={name:"frontend-engineering/前端工程实践/yargs使用.md"},o=l(`<h1 id="yargs-使用" tabindex="-1">yargs 使用 <a class="header-anchor" href="#yargs-使用" aria-label="Permalink to &quot;yargs 使用&quot;">​</a></h1><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">#!/usr/bin/env node</span></span>
