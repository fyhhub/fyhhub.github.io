import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.3d945e71.js";const F=JSON.parse('{"title":"tsconfig 不常见的配置","description":"","frontmatter":{},"headers":[],"relativePath":"frontend-advanced/typescript/tsconfig配置.md","filePath":"frontend-advanced/typescript/tsconfig配置.md","lastUpdated":1697890691000}'),p={name:"frontend-advanced/typescript/tsconfig配置.md"},o=l(`<h1 id="tsconfig-不常见的配置" tabindex="-1">tsconfig 不常见的配置 <a class="header-anchor" href="#tsconfig-不常见的配置" aria-label="Permalink to &quot;tsconfig 不常见的配置&quot;">​</a></h1><h2 id="compileroptions" tabindex="-1">compilerOptions <a class="header-anchor" href="#compileroptions" aria-label="Permalink to &quot;compilerOptions&quot;">​</a></h2><ul><li><p><strong>forceConsistentCasingInFileNames：</strong> import 文件名，是否区分大小写，设置为 true 后，强制区分大小写</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// 包含一个App.tsx文件</span></span>
