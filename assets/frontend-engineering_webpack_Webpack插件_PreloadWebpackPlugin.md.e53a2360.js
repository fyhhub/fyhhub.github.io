import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.3d945e71.js";const k=JSON.parse('{"title":"PreloadWebpackPlugin 插件实现","description":"","frontmatter":{},"headers":[],"relativePath":"frontend-engineering/webpack/Webpack插件/PreloadWebpackPlugin.md","filePath":"frontend-engineering/webpack/Webpack插件/PreloadWebpackPlugin.md","lastUpdated":1699603789000}'),p={name:"frontend-engineering/webpack/Webpack插件/PreloadWebpackPlugin.md"},o=l(`<h1 id="preloadwebpackplugin-插件实现" tabindex="-1">PreloadWebpackPlugin 插件实现 <a class="header-anchor" href="#preloadwebpackplugin-插件实现" aria-label="Permalink to &quot;PreloadWebpackPlugin 插件实现&quot;">​</a></h1><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">const</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">HtmlWebpackPlugin</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">require</span><span style="color:#E1E4E8;">(</span><span style="color:#9ECBFF;">&quot;html-webpack-plugin&quot;</span><span style="color:#E1E4E8;">);</span></span>
