import{_ as o,o as e,c as i,Q as t}from"./chunks/framework.353e5930.js";const T=JSON.parse('{"title":"Cookie 的各种字段","description":"","frontmatter":{},"headers":[],"relativePath":"basic/计算机网络/HTTP/Cookie的各种字段.md","filePath":"basic/计算机网络/HTTP/Cookie的各种字段.md"}'),a={name:"basic/计算机网络/HTTP/Cookie的各种字段.md"},n=t(`<h1 id="cookie-的各种字段" tabindex="-1">Cookie 的各种字段 <a class="header-anchor" href="#cookie-的各种字段" aria-label="Permalink to &quot;Cookie 的各种字段&quot;">​</a></h1><p>后端通过响应头<code>set-cookie</code>返回 cookie, 前端请求时携带 cookie 请求头字段</p><p><code>set-cookie</code>长这样</p><pre><code>Set-Cookie: id=a3fWa; Expires=Wed, 21 Oct 2015 07:28:00 GMT;
