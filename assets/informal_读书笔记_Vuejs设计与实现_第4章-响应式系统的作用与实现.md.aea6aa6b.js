import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.3d945e71.js";const d=JSON.parse('{"title":"第 4 章-响应式系统的作用与实现","description":"","frontmatter":{"order":4},"headers":[],"relativePath":"informal/读书笔记/Vuejs设计与实现/第4章-响应式系统的作用与实现.md","filePath":"informal/读书笔记/Vuejs设计与实现/第4章-响应式系统的作用与实现.md","lastUpdated":1694138420000}'),p={name:"informal/读书笔记/Vuejs设计与实现/第4章-响应式系统的作用与实现.md"},o=l(`<h1 id="第-4-章-响应式系统的作用与实现" tabindex="-1">第 4 章-响应式系统的作用与实现 <a class="header-anchor" href="#第-4-章-响应式系统的作用与实现" aria-label="Permalink to &quot;第 4 章-响应式系统的作用与实现&quot;">​</a></h1><h2 id="_4-1-响应式数据与副作用函数" tabindex="-1">4.1 响应式数据与副作用函数 <a class="header-anchor" href="#_4-1-响应式数据与副作用函数" aria-label="Permalink to &quot;4.1 响应式数据与副作用函数&quot;">​</a></h2><p>副作用函数指的是会产生副作用的函数，如下面的代码所示：</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">function</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">effect</span><span style="color:#E1E4E8;">() {</span></span>
