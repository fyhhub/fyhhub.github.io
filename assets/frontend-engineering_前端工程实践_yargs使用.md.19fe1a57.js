import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.353e5930.js";const g=JSON.parse('{"title":"yargs 使用","description":"","frontmatter":{},"headers":[],"relativePath":"frontend-engineering/前端工程实践/yargs使用.md","filePath":"frontend-engineering/前端工程实践/yargs使用.md"}'),p={name:"frontend-engineering/前端工程实践/yargs使用.md"},o=l(`<h1 id="yargs-使用" tabindex="-1">yargs 使用 <a class="header-anchor" href="#yargs-使用" aria-label="Permalink to &quot;yargs 使用&quot;">​</a></h1><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">#!/usr/bin/env node</span></span>
...
<span class="line"><span style="color:#6A737D;">// -r, --registry  定义全局仓库地址                                                                                                       [字符串] [默认值: www.baidu.com]</span></span>
<span class="line"><span style="color:#6A737D;">// -h, --help      显示帮助信息                                                                                                                                     [布尔]</span></span>
<span class="line"><span style="color:#6A737D;">// -v, --version   显示版本号</span></span></code></pre></div>`,2),e=[o];function c(r,t,E,y,i,F){return n(),a("div",null,e)}const D=s(p,[["render",c]]);export{g as __pageData,D as default};
